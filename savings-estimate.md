...
([`benchmark-setup.md`](benchmark-setup.md)) applied to the team's **actual**
...
(full table + methodology in [`benchmark-setup.md`](benchmark-setup.md)):
...
*Inputs: `benchmark-setup.md` (this repo) · `posten-app-experience/*/deploy/values-production.yaml`.
